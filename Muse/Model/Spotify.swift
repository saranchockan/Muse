 ...
 */
final public class Spotify: ObservableObject {
    ...
    let authorizationManagerKey = "spotifyAuthorizationManager" + (Auth.auth().currentUser?.uid ?? "")
    ...
    let keychain = Keychain(service: "com.cs71L.Muse")
